...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/smelting-control

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/smelting-control: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/smelting-control ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/DataExponent.o: DataExponent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
...
${OBJECTDIR}/SmeltingListElement.o: SmeltingListElement.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/SmeltingListElement.o SmeltingListElement.cpp
...
${OBJECTDIR}/DataGet.o: DataGet.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataGet.o DataGet.cpp

${OBJECTDIR}/SmeltingControlBriquette.o: SmeltingControlBriquette.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/SmeltingControlBriquette.o SmeltingControlBriquette.cpp

${OBJECTDIR}/DataFile.o: DataFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataFile.o DataFile.cpp

${OBJECTDIR}/DataCombined.o: DataCombined.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataCombined.o DataCombined.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/smelting-control
